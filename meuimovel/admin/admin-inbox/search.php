...
<form name="s_emailAdmin" action="" enctype="multipart/form-data" method="post">
    <label>
...
$sql_inboxAdmin = 'SELECT * FROM mailadmin WHERE emailNome LIKE :emailStatus ORDER BY emailData ASC';
