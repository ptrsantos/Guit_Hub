...
<div id="local">
   <div class="caminho">Onde Estou: Portal MEUIMÓVEL &raquo; Painel de Controle &raquo; Admin de perfil</div><!--caminho-->
...
$sql_atualizaPefil = 'UPDATE clientes SET nome = :clienteNome, senha = :clienteSenha, telefone = :clienteTelefone
