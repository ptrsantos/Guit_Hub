...
<?php 
include_once("Connections/painel_config.php");
...
$seleciona = mysqli_query($conecta, "SELECT * FROM imoveis WHERE imovelNegocio = '".$negocio."' ORDER BY ImovelTipo") or die(mysql_error());
